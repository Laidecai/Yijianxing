...
public abstract class StoreDeserializer implements INativeStore, IStore {
    ...
    private static ProductDefinition GetProductDefinition(JSONObject jSONObject) {
        try {
            return new ProductDefinition(jSONObject.getString(BreakpointSQLiteKey.ID), jSONObject.getString("storeSpecificId"), ProductType.valueOf(jSONObject.getString(e.r)));
        } catch (JSONException e) {
            throw new RuntimeException(e);
        }
    }
