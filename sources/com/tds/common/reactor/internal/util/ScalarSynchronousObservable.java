...
import com.tds.common.reactor.internal.producers.SingleProducer;
import com.tds.common.reactor.observers.Subscribers;
...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    ...
    public Observable<T> scalarScheduleOn(final Scheduler scheduler) {
        ...
        if (scheduler instanceof EventLoopsScheduler) {
            ...
            func1 = new Func1<Action0, Subscription>() { // from class: com.tds.common.reactor.internal.util.ScalarSynchronousObservable.1
            ...
            func1 = new Func1<Action0, Subscription>() { // from class: com.tds.common.reactor.internal.util.ScalarSynchronousObservable.2
                @Override // com.tds.common.reactor.functions.Func1
                public Subscription call(final Action0 action0) {
                    final Scheduler.Worker workerCreateWorker = scheduler.createWorker();
                    workerCreateWorker.schedule(new Action0() { // from class: com.tds.common.reactor.internal.util.ScalarSynchronousObservable.2.1
    ...
    public <R> Observable<R> scalarFlatMap(final Func1<? super T, ? extends Observable<? extends R>> func1) {
        return unsafeCreate(new Observable.OnSubscribe<R>() { // from class: com.tds.common.reactor.internal.util.ScalarSynchronousObservable.3
            @Override // com.tds.common.reactor.functions.Action1
