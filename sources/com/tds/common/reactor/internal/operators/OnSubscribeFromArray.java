    ...
    static final class FromArrayProducer<T> extends AtomicLong implements Producer {
        ...
        */
        void slowPath(long r11) {
            /*
                r10 = this;
                com.tds.common.reactor.Subscriber<? super T> r0 = r10.child
                T[] r1 = r10.array
                int r2 = r1.length
                int r3 = r10.index
                r4 = 0
            ...
            L2f:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tds.common.reactor.internal.operators.OnSubscribeFromArray.FromArrayProducer.slowPath(long):void");
        }
    }
}
