...
import com.tds.common.reactor.internal.util.RxRingBuffer;
import com.tds.common.reactor.internal.util.atomic.SpscAtomicArrayQueue;
import com.tds.common.reactor.internal.util.atomic.SpscExactAtomicArrayQueue;
...
public final class OperatorMerge<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    static final class HolderNoDelay {
        static final OperatorMerge<Object> INSTANCE = new OperatorMerge<>(false, IntCompanionObject.MAX_VALUE);
    ...
    static final class HolderDelayErrors {
        static final OperatorMerge<Object> INSTANCE = new OperatorMerge<>(true, IntCompanionObject.MAX_VALUE);
    ...
    static final class MergeSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        public MergeSubscriber(Subscriber<? super T> subscriber, boolean z, int i) {
            ...
            this.maxConcurrent = i;
            if (i == Integer.MAX_VALUE) {
                this.scalarEmissionLimit = IntCompanionObject.MAX_VALUE;
        ...
        */
        protected void emitScalar(com.tds.common.reactor.internal.operators.OperatorMerge.InnerSubscriber<T> r5, T r6, long r7) throws java.lang.Throwable {
            /*
                r4 = this;
                r0 = 1
                r1 = 0
                com.tds.common.reactor.Subscriber<? super T> r2 = r4.child     // Catch: java.lang.Throwable -> L8
            ...
            L8:
                ...
                if (r2 != 0) goto L19
                com.tds.common.reactor.exceptions.Exceptions.throwIfFatal(r6)     // Catch: java.lang.Throwable -> L46
            ...
            L20:
                ...
                if (r6 == 0) goto L2e
                com.tds.common.reactor.internal.operators.OperatorMerge$MergeProducer<T> r6 = r4.producer     // Catch: java.lang.Throwable -> L46
            ...
            L52:
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tds.common.reactor.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(com.tds.common.reactor.internal.operators.OperatorMerge$InnerSubscriber, java.lang.Object, long):void");
        }
        ...
        protected void queueScalar(T t) throws Throwable {
            ...
            if (spscUnboundedAtomicArrayQueue == null) {
                ...
                if (i == Integer.MAX_VALUE) {
                    spscUnboundedAtomicArrayQueue = new SpscUnboundedAtomicArrayQueue<>(128);
                } else {
        ...
        */
        void emitLoop() throws java.lang.Throwable {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tds.common.reactor.internal.operators.OperatorMerge.MergeSubscriber.emitLoop():void");
        }
