    ...
    */
    public void onNext(T r7) {
        ...
        Lc:
            ...
            if (r0 == 0) goto L24
            com.tds.common.reactor.observers.SerializedObserver$FastList r0 = r6.queue     // Catch: java.lang.Throwable -> L6f
            if (r0 != 0) goto L1b
            com.tds.common.reactor.observers.SerializedObserver$FastList r0 = new com.tds.common.reactor.observers.SerializedObserver$FastList     // Catch: java.lang.Throwable -> L6f
        ...
        L2d:
            monitor-enter(r6)
            com.tds.common.reactor.observers.SerializedObserver$FastList r1 = r6.queue     // Catch: java.lang.Throwable -> L63
            r2 = 0
            if (r1 != 0) goto L37
