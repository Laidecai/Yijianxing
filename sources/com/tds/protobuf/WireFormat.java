...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        static {
            ...
            BOOL = fieldType8;
            FieldType fieldType9 = new FieldType("STRING", 8, JavaType.STRING, i) { // from class: com.tds.protobuf.WireFormat.FieldType.1
                @Override // com.tds.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            STRING = fieldType9;
            FieldType fieldType10 = new FieldType("GROUP", 9, JavaType.MESSAGE, 3) { // from class: com.tds.protobuf.WireFormat.FieldType.2
                @Override // com.tds.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            GROUP = fieldType10;
            FieldType fieldType11 = new FieldType("MESSAGE", 10, JavaType.MESSAGE, i) { // from class: com.tds.protobuf.WireFormat.FieldType.3
                @Override // com.tds.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            MESSAGE = fieldType11;
            FieldType fieldType12 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, i) { // from class: com.tds.protobuf.WireFormat.FieldType.4
                @Override // com.tds.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
    ...
    enum Utf8Validation {
        LOOSE { // from class: com.tds.protobuf.WireFormat.Utf8Validation.1
            @Override // com.tds.protobuf.WireFormat.Utf8Validation
            Object readString(CodedInputStream codedInputStream) throws IOException {
                return codedInputStream.readString();
            }
        },
        STRICT { // from class: com.tds.protobuf.WireFormat.Utf8Validation.2
            @Override // com.tds.protobuf.WireFormat.Utf8Validation
            Object readString(CodedInputStream codedInputStream) throws IOException {
                return codedInputStream.readStringRequireUtf8();
            }
        },
        LAZY { // from class: com.tds.protobuf.WireFormat.Utf8Validation.3
            @Override // com.tds.protobuf.WireFormat.Utf8Validation
            Object readString(CodedInputStream codedInputStream) throws IOException {
    ...
    /* JADX INFO: renamed from: com.tds.protobuf.WireFormat$1, reason: invalid class name */
