...
final class TextFormatEscaper {
    ...
    static String escapeBytes(final ByteString byteString) {
        return escapeBytes(new ByteSequence() { // from class: com.tds.protobuf.TextFormatEscaper.1
            @Override // com.tds.protobuf.TextFormatEscaper.ByteSequence
            public int size() {
    ...
    static String escapeBytes(final byte[] bArr) {
        return escapeBytes(new ByteSequence() { // from class: com.tds.protobuf.TextFormatEscaper.2
            @Override // com.tds.protobuf.TextFormatEscaper.ByteSequence
            public int size() {
                return bArr.length;
            }
