    ...
    public int hash(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i2 >= 16) {
            ...
            do {
                ...
                int i8 = i7 + 4;
                iRotateLeft5 = Integer.rotateLeft(iRotateLeft5 + (SafeUtils.readIntLE(bArr, i8) * (-2048144777)), 13) * (-1640531535);
                i = i8 + 4;
            } while (i <= i5);
        ...
        while (i <= i4 - 4) {
            iRotateLeft6 = Integer.rotateLeft(iRotateLeft6 + (SafeUtils.readIntLE(bArr, i) * (-1028477379)), 17) * 668265263;
            i += 4;
        }
        while (i < i4) {
            iRotateLeft6 = Integer.rotateLeft(iRotateLeft6 + ((SafeUtils.readByte(bArr, i) & UByte.MAX_VALUE) * 374761393), 11) * (-1640531535);
            i++;
        }
