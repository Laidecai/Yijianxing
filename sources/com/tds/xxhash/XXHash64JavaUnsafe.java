...
final class XXHash64JavaUnsafe extends XXHash64 {
    ...
    public long hash(byte[] bArr, int i, int i2, long j) {
        ...
        if (i2 >= 32) {
            ...
            i3 = i;
            while (true) {
                jRotateLeft2 = Long.rotateLeft(j6 + (UnsafeUtils.readLongLE(bArr2, i3) * j2), 31) * (-7046029288634856825L);
                int i6 = i3 + 8;
                jRotateLeft3 = Long.rotateLeft(j5 + (UnsafeUtils.readLongLE(bArr2, i6) * j2), 31) * (-7046029288634856825L);
                int i7 = i6 + 8;
                jRotateLeft4 = Long.rotateLeft(j4 + (UnsafeUtils.readLongLE(bArr2, i7) * j2), 31) * (-7046029288634856825L);
                int i8 = i7 + 8;
                jRotateLeft5 = Long.rotateLeft(j3 + (UnsafeUtils.readLongLE(bArr2, i8) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
                i3 = i8 + 8;
                if (i3 > i5) {
                    break;
                }
        ...
        while (i3 <= i4 - 8) {
            jRotateLeft6 = (Long.rotateLeft(jRotateLeft6 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(bArr, i3) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i3 += 8;
        }
        if (i3 <= i4 - 4) {
            jRotateLeft6 = (Long.rotateLeft(jRotateLeft6 ^ ((((long) UnsafeUtils.readIntLE(bArr, i3)) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i3 += 4;
        }
        while (i3 < i4) {
            jRotateLeft6 = Long.rotateLeft(jRotateLeft6 ^ (((long) (UnsafeUtils.readByte(bArr, i3) & UByte.MAX_VALUE)) * 2870177450012600261L), 11) * (-7046029288634856825L);
            i3++;
        }
