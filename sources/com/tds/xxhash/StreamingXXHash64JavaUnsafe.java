...
final class StreamingXXHash64JavaUnsafe extends AbstractStreamingXXHash64Java {
    ...
    public long getValue() {
        ...
        if (i <= this.memSize - 4) {
            jRotateLeft2 = (Long.rotateLeft(jRotateLeft2 ^ ((((long) UnsafeUtils.readIntLE(this.memory, i)) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i += 4;
        }
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        while (i3 <= i5) {
            jRotateLeft2 = Long.rotateLeft(jRotateLeft2 + (UnsafeUtils.readLongLE(bArr, i3) * j), 31) * (-7046029288634856825L);
            int i6 = i3 + 8;
            jRotateLeft4 = Long.rotateLeft(jRotateLeft4 + (UnsafeUtils.readLongLE(bArr, i6) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            int i7 = i6 + 8;
            jRotateLeft = Long.rotateLeft(jRotateLeft + (UnsafeUtils.readLongLE(bArr, i7) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            int i8 = i7 + 8;
            jRotateLeft3 = Long.rotateLeft(jRotateLeft3 + (UnsafeUtils.readLongLE(bArr, i8) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            i3 = i8 + 8;
