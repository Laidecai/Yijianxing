...
final class LZ4JavaSafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:50:0x00cb, code lost:
        ...
        com.tds.lz4.LZ4SafeUtils.safeArraycopy(r18, r6, r21, r7, r9);
     */
    ...
    */
    public int decompress(byte[] r18, int r19, int r20, byte[] r21, int r22, int r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tds.lz4.LZ4JavaSafeSafeDecompressor.decompress(byte[], int, int, byte[], int, int):int");
    }
    ...
    */
    public int decompress(java.nio.ByteBuffer r18, int r19, int r20, java.nio.ByteBuffer r21, int r22, int r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tds.lz4.LZ4JavaSafeSafeDecompressor.decompress(java.nio.ByteBuffer, int, int, java.nio.ByteBuffer, int, int):int");
    }
}
