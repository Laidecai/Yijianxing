...
final class LZ4JavaUnsafeFastDecompressor extends LZ4FastDecompressor {
    ...
    public int decompress(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        int i8 = i2;
        while (true) {
            int i9 = UnsafeUtils.readByte(bArr, i7) & UByte.MAX_VALUE;
            int i10 = i7 + 1;
            int i11 = i9 >>> 4;
            if (i11 == 15) {
                while (true) {
                    i5 = i10 + 1;
                    b2 = UnsafeUtils.readByte(bArr, i10);
                    if (b2 != -1) {
                        break;
                    }
                    i11 += 255;
            ...
            if (i12 > i13) {
                ...
                LZ4UnsafeUtils.safeArraycopy(bArr, i10, bArr2, i8, i11);
                return (i10 + i11) - i;
            }
            LZ4UnsafeUtils.wildArraycopy(bArr, i10, bArr2, i8, i11);
            int i14 = i10 + i11;
            int shortLE = UnsafeUtils.readShortLE(bArr, i14);
            i7 = i14 + 2;
            int i15 = i12 - shortLE;
            if (i15 < i2) {
