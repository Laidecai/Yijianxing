...
public final class q implements Callable<u> {
    ...
    private u a(HttpResponse httpResponse, int i, String str) throws Throwable {
        ...
        try {
            ...
            if (contentType != null) {
                ...
                str3 = mapA.get(com.tds.tapdb.b.g.R);
    ...
    public static long b(HttpResponse httpResponse) {
        Header firstHeader = httpResponse.getFirstHeader(com.tds.tapdb.b.g.w);
        if (firstHeader != null) {
        ...
        Header firstHeader2 = httpResponse.getFirstHeader(com.tds.tapdb.b.g.C);
    ...
    private HttpUriRequest c() {
        ...
        if (this.j == null) {
            byte[] bArrB = this.c.b();
            String strB = this.c.b(com.tds.tapdb.b.g.r);
            if (bArrB != null) {
