...
import com.taptap.services.update.TapUpdateLogger;
...
import com.taptap.services.update.download.core.interceptor.BreakpointInterceptor;
import com.taptap.services.update.download.core.interceptor.FetchDataInterceptor;
import com.taptap.services.update.download.core.interceptor.Interceptor;
import com.taptap.services.update.download.core.interceptor.RetryInterceptor;
import com.taptap.services.update.download.core.interceptor.connect.CallServerInterceptor;
import com.taptap.services.update.download.core.interceptor.connect.HeaderInterceptor;
...
public class DownloadChain implements Runnable {
    private static final ExecutorService EXECUTOR = new ThreadPoolExecutor(0, IntCompanionObject.MAX_VALUE, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkDownload Cancel Block", false));
    ...
    private final Runnable releaseConnectionRunnable = new Runnable() { // from class: com.taptap.services.update.download.core.download.DownloadChain.1
    ...
    public void run() {
        ...
        try {
            try {
                ...
                TapUpdateLogger.e("download interrupt exception");
            }
        } finally {
