...
import com.taptap.services.update.download.core.NamedRunnable;
...
public class DownloadCall extends NamedRunnable implements Comparable<DownloadCall> {
    private static final ExecutorService EXECUTOR = new ThreadPoolExecutor(0, IntCompanionObject.MAX_VALUE, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkDownload Block", false));
    ...
    @Override // com.taptap.services.update.download.core.NamedRunnable
    ...
    /* JADX WARN: Removed duplicated region for block: B:76:0x015b A[EDGE_INSN: B:76:0x015b->B:45:0x015b BREAK  A[LOOP:0: B:3:0x0013->B:79:?], SYNTHETIC] */
    ...
    */
    public void execute() throws java.lang.InterruptedException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taptap.services.update.download.core.download.DownloadCall.execute():void");
    }
