...
import com.taptap.services.update.download.core.breakpoint.RemitSyncExecutor;
...
public class RemitStoreOnSQLite implements RemitSyncExecutor.RemitAgent, DownloadStore {
    ...
    @Override // com.taptap.services.update.download.core.breakpoint.RemitSyncExecutor.RemitAgent
