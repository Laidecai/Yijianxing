...
import com.taptap.services.update.download.core.breakpoint.BreakpointStoreOnCache;
...
import com.taptap.services.update.download.core.connection.DownloadUrlConnection;
import java.io.File;
...
public class Util {
    ...
    public static class EmptyLogger implements Logger {
        @Override // com.taptap.services.update.download.core.Util.Logger
    ...
    public static ThreadFactory threadFactory(final String str, final boolean z) {
        return new ThreadFactory() { // from class: com.taptap.services.update.download.core.Util.1
    ...
    public static DownloadStore createDefaultDatabase(Context context) {
        try {
            return (DownloadStore) Class.forName("com.taptap.services.update.download.core.breakpoint.BreakpointStoreOnSQLite").getDeclaredConstructor(Context.class).newInstance(context);
    ...
    public static DownloadConnection.Factory createDefaultConnectionFactory() {
        try {
            return (DownloadConnection.Factory) Class.forName("com.taptap.services.update.download.core.connection.DownloadOkHttp3Connection$Factory").getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
        } catch (ClassNotFoundException | IllegalAccessException | InstantiationException | NoSuchMethodException | InvocationTargetException unused) {
