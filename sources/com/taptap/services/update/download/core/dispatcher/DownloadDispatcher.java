...
import com.taptap.services.update.download.StatusUtil;
import com.taptap.services.update.download.core.IdentifiedTask;
...
import com.taptap.services.update.download.core.download.DownloadCall;
import java.io.File;
...
public class DownloadDispatcher {
    ...
    synchronized ExecutorService getExecutorService() {
        if (this.executorService == null) {
            this.executorService = new ThreadPoolExecutor(0, IntCompanionObject.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkDownload Download", false));
        }
