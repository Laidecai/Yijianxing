...
public class UnifiedListenerManager {
    ...
    public synchronized void replaceListener(DownloadTask downloadTask, DownloadListener downloadListener) {
        int id = downloadTask.getId();
        ArrayList<DownloadListener> arrayList = this.realListenerMap.get(id);
        if (arrayList == null) {
            arrayList = new ArrayList<>();
        ...
        for (DownloadListener downloadListener3 : arrayList) {
            if (downloadListener3.getClass().getName().equals(name)) {
                downloadListener2 = downloadListener3;
            }
        }
    ...
    public synchronized boolean isListenerAttached(DownloadTask downloadTask, DownloadListener downloadListener) {
    ...
    public DownloadListener getDownloadListener(DownloadTask downloadTask, String str) {
        ArrayList<DownloadListener> arrayList = this.realListenerMap.get(downloadTask.getId());
        ...
        for (DownloadListener downloadListener2 : arrayList) {
            if (downloadListener2.getClass().getName().equals(str)) {
