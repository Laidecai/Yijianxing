...
public class DownloadSerialQueue extends DownloadListener2 implements Runnable {
    ...
    private static final Executor SERIAL_EXECUTOR = new ThreadPoolExecutor(0, IntCompanionObject.MAX_VALUE, 30, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkDownload DynamicSerial", false));
