...
import com.taptap.services.update.download.core.listener.DownloadListener2;
import com.taptap.services.update.download.core.listener.DownloadListenerBunch;
import java.io.File;
...
public class DownloadContext {
    private static final Executor SERIAL_EXECUTOR = new ThreadPoolExecutor(0, IntCompanionObject.MAX_VALUE, 30, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkDownload Serial", false));
    ...
    public void start(final DownloadListener downloadListener, boolean z) {
        ...
        if (z) {
            ...
            executeOnSerialExecutor(new Runnable() { // from class: com.taptap.services.update.download.DownloadContext.1
    ...
    public void callbackQueueEndOnSerialLoop(boolean z) {
        ...
        if (z) {
            ...
            this.uiHandler.post(new Runnable() { // from class: com.taptap.services.update.download.DownloadContext.2
                @Override // java.lang.Runnable
                public void run() {
    ...
    public static class QueueSet {
        ...
        public int getMinIntervalMillisCallbackProcess() {
            ...
            return num == null ? DownloadTask.Builder.DEFAULT_MIN_INTERVAL_MILLIS_CALLBACK_PROCESS : num.intValue();
        }
