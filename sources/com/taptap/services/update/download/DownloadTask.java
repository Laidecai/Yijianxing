...
public class DownloadTask extends IdentifiedTask implements Comparable<DownloadTask> {
    ...
    @Override // com.taptap.services.update.download.core.IdentifiedTask
    public int getId() {
        return this.id;
    }
    ...
    public static class Builder {
        ...
        public Builder(String str, File file) {
            ...
            this.minIntervalMillisCallbackProcess = DEFAULT_MIN_INTERVAL_MILLIS_CALLBACK_PROCESS;
    ...
    public boolean equals(Object obj) {
        ...
        if (getTag() != null && downloadTask.getTag() != null) {
            return getTag().equals(downloadTask.getTag());
        }
