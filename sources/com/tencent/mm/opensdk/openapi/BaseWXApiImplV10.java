...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    private String getTokenFromWX(Context context) {
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "637928960"}, null);
    ...
    private boolean sendFinderShareVideo(Context context, BaseReq baseReq) {
        ...
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/finderShareVideo"), null, null, new String[]{this.appId, req.videoPath, req.title, req.url, req.extData}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
                        ...
                        if (str != null && str.contains("openbusinesswebview")) {
                            try {
                                ...
                                if (uri != null && "openbusinesswebview".equals(uri.getHost())) {
                                    ...
                                    String queryParameter2 = uri.getQueryParameter(e.r);
                                    if (queryParameter2 != null && queryParameter2.length() > 0) {
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0022a.a = "com.tencent.mm";
        c0022a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0022a.c = "weixin://registerapp?appid=" + this.appId;
        c0022a.d = j;
        return a.a(this.context, c0022a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0022a c0022a = new a.C0022a();
        c0022a.a = "com.tencent.mm";
        c0022a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0022a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0022a);
    }
}
