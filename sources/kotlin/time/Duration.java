...
public final class Duration implements Comparable<Duration> {
    ...
    public static final double m1306timesUwyO8pc(double d, int i) {
        return m1279constructorimpl(d * ((double) i));
    }
    ...
    public static final int m1286getHoursComponentimpl(double d) {
        return (int) (m1288getInHoursimpl(d) % ((double) 24));
    }
    ...
    public static final int m1294getMinutesComponentimpl(double d) {
        return (int) (m1291getInMinutesimpl(d) % ((double) 60));
    }
    ...
    public static final int m1296getSecondsComponentimpl(double d) {
        return (int) (m1293getInSecondsimpl(d) % ((double) 60));
    }
    ...
    */
    ...
    public static final String m1318toStringimpl(double d, TimeUnit unit, int i) {
        ...
        double dM1311toDoubleimpl = m1311toDoubleimpl(d, unit);
        StringBuilder sb = new StringBuilder();
        sb.append(Math.abs(dM1311toDoubleimpl) < 1.0E14d ? FormatToDecimalsKt.formatToExactDecimals(dM1311toDoubleimpl, RangesKt.coerceAtMost(i, 12)) : FormatToDecimalsKt.formatScientific(dM1311toDoubleimpl));
    ...
    public static final String m1313toIsoStringimpl(double d) {
        ...
        sb.append("PT");
        double dM1285getAbsoluteValueUwyO8pc = m1285getAbsoluteValueUwyO8pc(d);
        int iM1288getInHoursimpl = (int) m1288getInHoursimpl(dM1285getAbsoluteValueUwyO8pc);
        int iM1294getMinutesComponentimpl = m1294getMinutesComponentimpl(dM1285getAbsoluteValueUwyO8pc);
        int iM1296getSecondsComponentimpl = m1296getSecondsComponentimpl(dM1285getAbsoluteValueUwyO8pc);
        int iM1295getNanosecondsComponentimpl = m1295getNanosecondsComponentimpl(dM1285getAbsoluteValueUwyO8pc);
        boolean z = true;
        boolean z2 = iM1288getInHoursimpl != 0;
        boolean z3 = (iM1296getSecondsComponentimpl == 0 && iM1295getNanosecondsComponentimpl == 0) ? false : true;
        if (iM1294getMinutesComponentimpl == 0 && (!z3 || !z2)) {
            z = false;
        }
        if (z2) {
            sb.append(iM1288getInHoursimpl);
            sb.append('H');
        }
        if (z) {
            sb.append(iM1294getMinutesComponentimpl);
            sb.append('M');
        }
        if (z3 || (!z2 && !z)) {
            sb.append(iM1296getSecondsComponentimpl);
            if (iM1295getNanosecondsComponentimpl != 0) {
                sb.append('.');
                String strPadStart = StringsKt.padStart(String.valueOf(iM1295getNanosecondsComponentimpl), 9, '0');
                if (iM1295getNanosecondsComponentimpl % 1000000 == 0) {
                    sb.append((CharSequence) strPadStart, 0, 3);
                    Intrinsics.checkNotNullExpressionValue(sb, "this.append(value, startIndex, endIndex)");
                } else if (iM1295getNanosecondsComponentimpl % 1000 == 0) {
