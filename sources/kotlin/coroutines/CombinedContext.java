...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    static final class C00451 extends Lambda implements Function2<Unit, CoroutineContext.Element, Unit> {
        final /* synthetic */ CoroutineContext[] $elements;
        final /* synthetic */ Ref.IntRef $index;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00451(CoroutineContext[] coroutineContextArr, Ref.IntRef intRef) {
            super(2);
        ...
        public final void invoke2(Unit unit, CoroutineContext.Element element) {
            ...
            CoroutineContext[] coroutineContextArr = coroutineContextArr;
    ...
    /* JADX INFO: renamed from: kotlin.coroutines.CombinedContext$toString$1 */
    /* JADX INFO: compiled from: CoroutineContextImpl.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u0004H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "acc", "element", "Lkotlin/coroutines/CoroutineContext$Element;", "invoke"}, k = 3, mv = {1, 4, 1})
    static final class AnonymousClass1 extends Lambda implements Function2<String, CoroutineContext.Element, String> {
    ...
    public String toString() {
        return "[" + ((String) fold("", AnonymousClass1.INSTANCE)) + "]";
    }
    ...
    private final Object writeReplace() {
        ...
        fold(Unit.INSTANCE, new Function2<Unit, CoroutineContext.Element, Unit>() { // from class: kotlin.coroutines.CombinedContext.writeReplace.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00451(CoroutineContext[] coroutineContextArr2, Ref.IntRef intRef2) {
                super(2);
                coroutineContextArr = coroutineContextArr2;
                intRef = intRef2;
            }
        ...
        return new Serialized(coroutineContextArr2);
    }
