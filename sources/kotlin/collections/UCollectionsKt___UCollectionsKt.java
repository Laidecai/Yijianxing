...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] bArrM82constructorimpl = UByteArray.m82constructorimpl(toUByteArray.size());
        Iterator<UByte> it = toUByteArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UByteArray.m93setVurrAj0(bArrM82constructorimpl, i, it.next().getData());
            i++;
        }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int[] iArrM152constructorimpl = UIntArray.m152constructorimpl(toUIntArray.size());
        Iterator<UInt> it = toUIntArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UIntArray.m163setVXSXFK8(iArrM152constructorimpl, i, it.next().getData());
            i++;
        }
        return iArrM152constructorimpl;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> toULongArray) {
        ...
        long[] jArrM222constructorimpl = ULongArray.m222constructorimpl(toULongArray.size());
        Iterator<ULong> it = toULongArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            ULongArray.m233setk8EXiF4(jArrM222constructorimpl, i, it.next().getData());
            i++;
        }
        return jArrM222constructorimpl;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] sArrM318constructorimpl = UShortArray.m318constructorimpl(toUShortArray.size());
        Iterator<UShort> it = toUShortArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UShortArray.m329set01HTLdE(sArrM318constructorimpl, i, it.next().getData());
            i++;
        }
        return sArrM318constructorimpl;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> sum) {
        ...
        while (it.hasNext()) {
            iM107constructorimpl = UInt.m107constructorimpl(iM107constructorimpl + it.next().getData());
        }
    ...
    public static final long sumOfULong(Iterable<ULong> sum) {
        ...
        long jM177constructorimpl = 0;
        while (it.hasNext()) {
            jM177constructorimpl = ULong.m177constructorimpl(jM177constructorimpl + it.next().getData());
        }
        return jM177constructorimpl;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        int iM107constructorimpl = 0;
        while (it.hasNext()) {
            iM107constructorimpl = UInt.m107constructorimpl(iM107constructorimpl + UInt.m107constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
        return iM107constructorimpl;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        int iM107constructorimpl = 0;
        while (it.hasNext()) {
            iM107constructorimpl = UInt.m107constructorimpl(iM107constructorimpl + UInt.m107constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM107constructorimpl;
    }
}
