...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00511<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        C00511(Sequence sequence, Function0 function0, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C00511 c00511 = new C00511(this.$this_ifEmpty, this.$defaultValue, completion);
            c00511.L$0 = obj;
            return c00511;
        }
        ...
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C00511) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> ifEmpty, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00511(ifEmpty, defaultValue, null));
    }
    ...
    static final class C00521<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00521(Sequence sequence, Random random, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C00521 c00521 = new C00521(this.$this_shuffled, this.$random, completion);
            c00521.L$0 = obj;
            return c00521;
        }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> shuffled, Random random) {
        ...
        return SequencesKt.sequence(new C00521(shuffled, random, null));
    }
    ...
    static final class C00471<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00471(Sequence sequence, Function2 function2, Function1 function1, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C00471 c00471 = new C00471(this.$source, this.$transform, this.$iterator, completion);
            c00471.L$0 = obj;
            return c00471;
        }
