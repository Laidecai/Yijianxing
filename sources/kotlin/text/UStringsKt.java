...
public final class UStringsKt {
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m107constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int iM107constructorimpl = UInt.m107constructorimpl(i);
        int iM336uintDivideJ1ME1BU = 119304647;
        while (i3 < length) {
            int iDigitOf = CharsKt.digitOf(toUIntOrNull.charAt(i3), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.uintCompare(i2, iM336uintDivideJ1ME1BU) > 0) {
                if (iM336uintDivideJ1ME1BU == 119304647) {
                    iM336uintDivideJ1ME1BU = UnsignedKt.m336uintDivideJ1ME1BU(-1, iM107constructorimpl);
                    if (UnsignedKt.uintCompare(i2, iM336uintDivideJ1ME1BU) > 0) {
                    }
                }
                return null;
            }
            int iM107constructorimpl2 = UInt.m107constructorimpl(i2 * iM107constructorimpl);
            int iM107constructorimpl3 = UInt.m107constructorimpl(UInt.m107constructorimpl(iDigitOf) + iM107constructorimpl2);
            if (UnsignedKt.uintCompare(iM107constructorimpl3, iM107constructorimpl2) < 0) {
                return null;
            }
            i3++;
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long jM177constructorimpl = ULong.m177constructorimpl(i);
        long j2 = 0;
        long jM338ulongDivideeb3DHEI = 512409557603043100L;
        while (i2 < length) {
            int iDigitOf = CharsKt.digitOf(toULongOrNull.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.ulongCompare(j2, jM338ulongDivideeb3DHEI) > 0) {
                if (jM338ulongDivideeb3DHEI == 512409557603043100L) {
                    jM338ulongDivideeb3DHEI = UnsignedKt.m338ulongDivideeb3DHEI(j, jM177constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, jM338ulongDivideeb3DHEI) > 0) {
                    }
                }
                return null;
            }
            long jM177constructorimpl2 = ULong.m177constructorimpl(j2 * jM177constructorimpl);
            long jM177constructorimpl3 = ULong.m177constructorimpl(ULong.m177constructorimpl(((long) UInt.m107constructorimpl(iDigitOf)) & 4294967295L) + jM177constructorimpl2);
            if (UnsignedKt.ulongCompare(jM177constructorimpl3, jM177constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = jM177constructorimpl3;
            j = -1;
        }
