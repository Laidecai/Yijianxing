...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharIterator iterator(CharSequence iterator) {
        Intrinsics.checkNotNullParameter(iterator, "$this$iterator");
        return new CharIterator() { // from class: kotlin.text.StringsKt__StringsKt.iterator.1
            final /* synthetic */ CharSequence $this_iterator;
            private int index;

            AnonymousClass1(CharSequence iterator2) {
                charSequence = iterator2;
            }
    ...
    static final class C00741 extends Lambda implements Function1<IntRange, String> {
        final /* synthetic */ CharSequence $this_splitToSequence;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00741(CharSequence charSequence) {
            super(1);
            charSequence = charSequence;
        }
    ...
    public static final Sequence<String> splitToSequence(CharSequence splitToSequence, String[] delimiters, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(splitToSequence, delimiters, 0, z, i, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00741(CharSequence splitToSequence2) {
                super(1);
    ...
    public static final Sequence<String> splitToSequence(CharSequence splitToSequence, char[] delimiters, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(splitToSequence, delimiters, 0, z, i, 2, (Object) null), new Function1<IntRange, String>() { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.2
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass2(CharSequence splitToSequence2) {
                super(1);
                charSequence = splitToSequence2;
            }
