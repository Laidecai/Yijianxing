...
public class ShortcutManagerCompat {
    ...
    private static int getIconDimensionInternal(final Context context, final boolean isHorizontal) {
        ...
        int iMax = Math.max(1, Build.VERSION.SDK_INT < 19 || activityManager == null || activityManager.isLowRamDevice() ? DEFAULT_MAX_ICON_DIMENSION_LOWRAM_DP : DEFAULT_MAX_ICON_DIMENSION_DP);
