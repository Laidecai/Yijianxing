package tds.androidx.core.content;
...
public final class LocalBroadcastManager {
    ...
    private LocalBroadcastManager(Context context) {
        ...
        this.mHandler = new Handler(context.getMainLooper()) { // from class: tds.androidx.core.content.LocalBroadcastManager.1
                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (iMatch >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (iMatch != -4 ? iMatch != -3 ? iMatch != -2 ? iMatch != -1 ? "unknown reason" : e.r : "data" : "action" : "category"));
                        }
                    }
