...
import tds.androidx.core.graphics.Insets;
...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        @Override // tds.androidx.core.view.WindowInsetsCompat.Impl
        boolean isRound() {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 2) {
                ...
                if (stableInsets2 != null) {
                    iMin = Math.min(iMin, stableInsets2.bottom);
                }
    ...
    private static class Impl29 extends Impl28 {
        ...
        @Override // tds.androidx.core.view.WindowInsetsCompat.Impl20, tds.androidx.core.view.WindowInsetsCompat.Impl
        WindowInsetsCompat inset(int i, int i2, int i3, int i4) {
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        @Override // tds.androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setSystemWindowInsets(Insets insets) {
