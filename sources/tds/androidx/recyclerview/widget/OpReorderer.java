...
class OpReorderer {
    ...
    */
    void swapMoveUpdate(java.util.List<tds.androidx.recyclerview.widget.AdapterHelper.UpdateOp> r8, int r9, tds.androidx.recyclerview.widget.AdapterHelper.UpdateOp r10, int r11, tds.androidx.recyclerview.widget.AdapterHelper.UpdateOp r12) {
        /*
            r7 = this;
        ...
        Lf:
            ...
            int r0 = r0 - r4
            r12.itemCount = r0
            tds.androidx.recyclerview.widget.OpReorderer$Callback r0 = r7.mCallback
            int r1 = r10.positionStart
            java.lang.Object r5 = r12.payload
            tds.androidx.recyclerview.widget.AdapterHelper$UpdateOp r0 = r0.obtainUpdateOp(r2, r1, r4, r5)
            goto L29
        L28:
            r0 = r3
        L29:
        ...
        L35:
            ...
            int r1 = r1 - r3
            tds.androidx.recyclerview.widget.OpReorderer$Callback r3 = r7.mCallback
            int r5 = r10.positionStart
            int r5 = r5 + r4
            java.lang.Object r4 = r12.payload
            tds.androidx.recyclerview.widget.AdapterHelper$UpdateOp r3 = r3.obtainUpdateOp(r2, r5, r1, r4)
        ...
        L61:
            r8.remove(r9)
            tds.androidx.recyclerview.widget.OpReorderer$Callback r10 = r7.mCallback
        ...
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.OpReorderer.swapMoveUpdate(java.util.List, int, tds.androidx.recyclerview.widget.AdapterHelper$UpdateOp, int, tds.androidx.recyclerview.widget.AdapterHelper$UpdateOp):void");
    }
