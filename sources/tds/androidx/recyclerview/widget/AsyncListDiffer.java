...
import tds.androidx.recyclerview.widget.AsyncDifferConfig;
import tds.androidx.recyclerview.widget.DiffUtil;
...
public class AsyncListDiffer<T> {
    ...
    public void submitList(final List<T> list, final Runnable runnable) {
        ...
        this.mConfig.getBackgroundThreadExecutor().execute(new Runnable() { // from class: tds.androidx.recyclerview.widget.AsyncListDiffer.1
            @Override // java.lang.Runnable
            public void run() {
                final DiffUtil.DiffResult diffResultCalculateDiff = DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: tds.androidx.recyclerview.widget.AsyncListDiffer.1.1
                    @Override // tds.androidx.recyclerview.widget.DiffUtil.Callback
                ...
                AsyncListDiffer.this.mMainThreadExecutor.execute(new Runnable() { // from class: tds.androidx.recyclerview.widget.AsyncListDiffer.1.2
                    @Override // java.lang.Runnable
                    public void run() {
