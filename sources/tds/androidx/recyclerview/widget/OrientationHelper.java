...
public abstract class OrientationHelper {
    ...
    public static OrientationHelper createHorizontalHelper(RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) { // from class: tds.androidx.recyclerview.widget.OrientationHelper.1
            @Override // tds.androidx.recyclerview.widget.OrientationHelper
    ...
    public static OrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) { // from class: tds.androidx.recyclerview.widget.OrientationHelper.2
            @Override // tds.androidx.recyclerview.widget.OrientationHelper
            public int getEndAfterPadding() {
