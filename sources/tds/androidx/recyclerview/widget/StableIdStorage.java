...
import tds.androidx.collection.LongSparseArray;
...
interface StableIdStorage {
    ...
    public static class NoStableIdStorage implements StableIdStorage {
        private final StableIdLookup mNoIdLookup = new StableIdLookup() { // from class: tds.androidx.recyclerview.widget.StableIdStorage.NoStableIdStorage.1
    ...
    public static class SharedPoolStableIdStorage implements StableIdStorage {
        private final StableIdLookup mSameIdLookup = new StableIdLookup() { // from class: tds.androidx.recyclerview.widget.StableIdStorage.SharedPoolStableIdStorage.1
            @Override // tds.androidx.recyclerview.widget.StableIdStorage.StableIdLookup
            public long localToGlobal(long j) {
                return j;
            }
