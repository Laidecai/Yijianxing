...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                AnonymousClass1 anonymousClass1 = new Runnable() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.1
            ...
            if (z3) {
                ...
                AnonymousClass2 anonymousClass2 = new Runnable() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.2
            ...
            if (z4) {
                ...
                AnonymousClass3 anonymousClass3 = new Runnable() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.3
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$1 */
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$2 */
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$3 */
    ...
    @Override // tds.androidx.recyclerview.widget.SimpleItemAnimator
    ...
    private void animateRemoveImpl(RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.4
            final /* synthetic */ ViewPropertyAnimator val$animation;
            final /* synthetic */ RecyclerView.ViewHolder val$holder;
            final /* synthetic */ View val$view;

            AnonymousClass4(RecyclerView.ViewHolder viewHolder2, ViewPropertyAnimator viewPropertyAnimatorAnimate2, View view2) {
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$4 */
    ...
    void animateAddImpl(RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.5
            final /* synthetic */ ViewPropertyAnimator val$animation;
            final /* synthetic */ RecyclerView.ViewHolder val$holder;
            final /* synthetic */ View val$view;

            AnonymousClass5(RecyclerView.ViewHolder viewHolder2, View view2, ViewPropertyAnimator viewPropertyAnimatorAnimate2) {
                viewHolder = viewHolder2;
                view = view2;
                viewPropertyAnimator = viewPropertyAnimatorAnimate2;
            }
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$5 */
    ...
    void animateMoveImpl(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        viewPropertyAnimatorAnimate.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.6
            final /* synthetic */ ViewPropertyAnimator val$animation;
            ...
            AnonymousClass6(RecyclerView.ViewHolder viewHolder2, int i52, View view2, int i62, ViewPropertyAnimator viewPropertyAnimatorAnimate2) {
                viewHolder = viewHolder2;
                i = i52;
                view = view2;
                i = i62;
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$6 */
    ...
    void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.7
        ...
        if (view2 != null) {
            ...
            viewPropertyAnimatorAnimate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: tds.androidx.recyclerview.widget.DefaultItemAnimator.8
                final /* synthetic */ ChangeInfo val$changeInfo;
                final /* synthetic */ View val$newView;
                final /* synthetic */ ViewPropertyAnimator val$newViewAnimation;

                AnonymousClass8(ChangeInfo changeInfo2, ViewPropertyAnimator viewPropertyAnimatorAnimate2, View view22) {
                    changeInfo = changeInfo2;
                    viewPropertyAnimator = viewPropertyAnimatorAnimate2;
                    view = view22;
                }
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$7 */
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.DefaultItemAnimator$8 */
