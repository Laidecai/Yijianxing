...
import tds.androidx.recyclerview.widget.RecyclerView.ViewHolder;
...
public abstract class ListAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected ListAdapter(DiffUtil.ItemCallback<T> itemCallback) {
        AsyncListDiffer.ListListener<T> listListener = new AsyncListDiffer.ListListener<T>() { // from class: tds.androidx.recyclerview.widget.ListAdapter.1
