...
class NestedAdapterWrapper {
    ...
    private RecyclerView.AdapterDataObserver mAdapterObserver = new RecyclerView.AdapterDataObserver() { // from class: tds.androidx.recyclerview.widget.NestedAdapterWrapper.1
