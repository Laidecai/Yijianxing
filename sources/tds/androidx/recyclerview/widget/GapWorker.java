...
final class GapWorker implements Runnable {
    ...
    static Comparator<Task> sTaskComparator = new Comparator<Task>() { // from class: tds.androidx.recyclerview.widget.GapWorker.1
        AnonymousClass1() {
        }
    ...
    static class LayoutPrefetchRegistryImpl implements RecyclerView.LayoutManager.LayoutPrefetchRegistry {
        ...
        @Override // tds.androidx.recyclerview.widget.RecyclerView.LayoutManager.LayoutPrefetchRegistry
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.GapWorker$1 */
