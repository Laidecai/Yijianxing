...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    @Override // tds.androidx.recyclerview.widget.LinearLayoutManager, tds.androidx.recyclerview.widget.RecyclerView.LayoutManager
        ...
        */
        public int getSpanIndex(int r6, int r7) {
            ...
            L37:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup.getSpanIndex(int, int):int");
        }
        ...
        */
        public int getSpanGroupIndex(int r7, int r8) {
            ...
            L45:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup.getSpanGroupIndex(int, int):int");
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public android.view.View onFocusSearchFailed(android.view.View r23, int r24, tds.androidx.recyclerview.widget.RecyclerView.Recycler r25, tds.androidx.recyclerview.widget.RecyclerView.State r26) {
        /*
            Method dump skipped, instruction units count: 338
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.GridLayoutManager.onFocusSearchFailed(android.view.View, int, tds.androidx.recyclerview.widget.RecyclerView$Recycler, tds.androidx.recyclerview.widget.RecyclerView$State):android.view.View");
    }
