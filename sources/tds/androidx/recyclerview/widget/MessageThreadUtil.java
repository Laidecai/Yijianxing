...
import tds.androidx.recyclerview.widget.TileList;
...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.MessageThreadUtil$1, reason: invalid class name */
    class AnonymousClass1 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: tds.androidx.recyclerview.widget.MessageThreadUtil.1.1
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.MessageThreadUtil$2, reason: invalid class name */
    class AnonymousClass2 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: tds.androidx.recyclerview.widget.MessageThreadUtil.2.1
            @Override // java.lang.Runnable
            public void run() {
                while (true) {
