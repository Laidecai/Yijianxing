...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    FastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ...
        this.mHideRunnable = new Runnable() { // from class: tds.androidx.recyclerview.widget.FastScroller.1
            @Override // java.lang.Runnable
            public void run() {
                FastScroller.this.hide(TdsBaseException.SERVER_ERROR);
            }
        };
        this.mOnScrollListener = new RecyclerView.OnScrollListener() { // from class: tds.androidx.recyclerview.widget.FastScroller.2
