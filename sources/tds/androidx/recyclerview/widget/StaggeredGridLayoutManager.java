...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new Runnable() { // from class: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.1
    ...
    */
    android.view.View hasGapsToFix() {
        ...
        L2e:
            ...
            tds.androidx.recyclerview.widget.StaggeredGridLayoutManager$Span r9 = r8.mSpan
            int r9 = r9.mIndex
        ...
        L59:
            ...
            if (r10 == 0) goto L77
            tds.androidx.recyclerview.widget.OrientationHelper r10 = r12.mPrimaryOrientation
            int r10 = r10.getDecoratedEnd(r7)
            tds.androidx.recyclerview.widget.OrientationHelper r11 = r12.mPrimaryOrientation
        ...
        L8b:
            ...
            tds.androidx.recyclerview.widget.StaggeredGridLayoutManager$Span r8 = r8.mSpan
            int r8 = r8.mIndex
            tds.androidx.recyclerview.widget.StaggeredGridLayoutManager$Span r9 = r9.mSpan
            int r9 = r9.mIndex
            int r8 = r8 - r9
            if (r8 >= 0) goto La0
            r8 = 1
        ...
        Lab:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.hasGapsToFix():android.view.View");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void onLayoutChildren(tds.androidx.recyclerview.widget.RecyclerView.Recycler r9, tds.androidx.recyclerview.widget.RecyclerView.State r10, boolean r11) {
        /*
            Method dump skipped, instruction units count: 389
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.onLayoutChildren(tds.androidx.recyclerview.widget.RecyclerView$Recycler, tds.androidx.recyclerview.widget.RecyclerView$State, boolean):void");
    }
    ...
    private void fixStartGap(RecyclerView.Recycler recycler, RecyclerView.State state, boolean z) {
        int startAfterPadding;
        int minStart = getMinStart(IntCompanionObject.MAX_VALUE);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void updateLayoutState(int r5, tds.androidx.recyclerview.widget.RecyclerView.State r6) {
        /*
            r4 = this;
            tds.androidx.recyclerview.widget.LayoutState r0 = r4.mLayoutState
            r1 = 0
            r0.mAvailable = r1
            tds.androidx.recyclerview.widget.LayoutState r0 = r4.mLayoutState
        ...
        L1e:
            if (r0 != r5) goto L27
            tds.androidx.recyclerview.widget.OrientationHelper r5 = r4.mPrimaryOrientation
        ...
        L32:
            ...
            if (r0 == 0) goto L4f
            tds.androidx.recyclerview.widget.LayoutState r0 = r4.mLayoutState
            tds.androidx.recyclerview.widget.OrientationHelper r3 = r4.mPrimaryOrientation
            int r3 = r3.getStartAfterPadding()
            int r3 = r3 - r6
            r0.mStartLine = r3
            tds.androidx.recyclerview.widget.LayoutState r6 = r4.mLayoutState
            tds.androidx.recyclerview.widget.OrientationHelper r0 = r4.mPrimaryOrientation
        ...
        L4f:
            ...
            int r3 = r3 + r5
            r0.mEndLine = r3
            tds.androidx.recyclerview.widget.LayoutState r5 = r4.mLayoutState
            int r6 = -r6
            r5.mStartLine = r6
        L5f:
            tds.androidx.recyclerview.widget.LayoutState r5 = r4.mLayoutState
            ...
            r5.mRecycle = r2
            tds.androidx.recyclerview.widget.LayoutState r5 = r4.mLayoutState
            tds.androidx.recyclerview.widget.OrientationHelper r6 = r4.mPrimaryOrientation
            int r6 = r6.getMode()
            if (r6 != 0) goto L7a
            tds.androidx.recyclerview.widget.OrientationHelper r6 = r4.mPrimaryOrientation
            int r6 = r6.getEnd()
        ...
        L7a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.updateLayoutState(int, tds.androidx.recyclerview.widget.RecyclerView$State):void");
    }
    ...
    */
    private void handleUpdate(int r7, int r8, int r9) {
        ...
        L1c:
            r3 = r7
        L1d:
            tds.androidx.recyclerview.widget.StaggeredGridLayoutManager$LazySpanLookup r4 = r6.mLazySpanLookup
            ...
            goto L41
        L2b:
            tds.androidx.recyclerview.widget.StaggeredGridLayoutManager$LazySpanLookup r9 = r6.mLazySpanLookup
            r9.offsetForRemoval(r7, r4)
            tds.androidx.recyclerview.widget.StaggeredGridLayoutManager$LazySpanLookup r7 = r6.mLazySpanLookup
        ...
        L56:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.handleUpdate(int, int, int):void");
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            i2 = layoutState.mLayoutDirection == 1 ? IntCompanionObject.MAX_VALUE : Integer.MIN_VALUE;
        } else {
    ...
    @Override // tds.androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Parcelable.Creator<FullSpanItem> CREATOR = new Parcelable.Creator<FullSpanItem>() { // from class: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.LazySpanLookup.FullSpanItem.1
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: tds.androidx.recyclerview.widget.StaggeredGridLayoutManager.SavedState.1
            @Override // android.os.Parcelable.Creator
