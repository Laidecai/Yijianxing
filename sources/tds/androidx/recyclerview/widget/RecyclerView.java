...
import tds.androidx.core.os.TraceCompat;
import tds.androidx.core.util.Preconditions;
import tds.androidx.core.view.MotionEventCompat;
import tds.androidx.core.view.NestedScrollingChild2;
import tds.androidx.core.view.NestedScrollingChild3;
import tds.androidx.core.view.NestedScrollingChildHelper;
import tds.androidx.core.view.ScrollingView;
import tds.androidx.core.view.ViewCompat;
import tds.androidx.core.view.ViewConfigurationCompat;
import tds.androidx.customview.view.AbsSavedState;
import tds.androidx.recyclerview.widget.AdapterHelper;
import tds.androidx.recyclerview.widget.ChildHelper;
import tds.androidx.recyclerview.widget.GapWorker;
import tds.androidx.recyclerview.widget.ViewBoundsCheck;
import tds.androidx.recyclerview.widget.ViewInfoStore;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static class SimpleOnItemTouchListener implements OnItemTouchListener {
        @Override // tds.androidx.recyclerview.widget.RecyclerView.OnItemTouchListener
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: tds.androidx.recyclerview.widget.RecyclerView.4
            @Override // tds.androidx.recyclerview.widget.ViewInfoStore.ProcessCallback
        ...
        createLayoutManager(context, null, attributeSet, i, 0);
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: tds.androidx.recyclerview.widget.RecyclerView.5
            @Override // tds.androidx.recyclerview.widget.ChildHelper.Callback
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: tds.androidx.recyclerview.widget.RecyclerView.6
            @Override // tds.androidx.recyclerview.widget.AdapterHelper.Callback
    ...
    @Override // android.view.View, tds.androidx.core.view.ScrollingView
    ...
    */
    private void pullGlows(float r7, float r8, float r9, float r10) {
        /*
            ...
            float r9 = r9 / r5
            float r9 = r0 - r9
            tds.androidx.core.widget.EdgeEffectCompat.onPull(r3, r4, r9)
        L1f:
            r9 = 1
            goto L3c
        L21:
        ...
        L3c:
            ...
            float r3 = (float) r3
            float r7 = r7 / r3
            tds.androidx.core.widget.EdgeEffectCompat.onPull(r9, r0, r7)
            goto L72
        L56:
            int r3 = (r10 > r2 ? 1 : (r10 == r2 ? 0 : -1))
            if (r3 <= 0) goto L71
            ...
            float r7 = r7 / r4
            float r0 = r0 - r7
            tds.androidx.core.widget.EdgeEffectCompat.onPull(r9, r3, r0)
            goto L72
        L71:
            r1 = r9
        L72:
            ...
            if (r7 == 0) goto L7f
        L7c:
            tds.androidx.core.view.ViewCompat.postInvalidateOnAnimation(r6)
        L7f:
            return
        */
  ...
  0x00df: PHI (r0v36 int) = (r0v26 int), (r0v40 int) binds: [B:41:0x00c8, B:45:0x00db] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public boolean onGenericMotionEvent(android.view.MotionEvent r6) {
        /*
            r5 = this;
            tds.androidx.recyclerview.widget.RecyclerView$LayoutManager r0 = r5.mLayout
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
        ...
        L2c:
            r0 = 0
        L2d:
            tds.androidx.recyclerview.widget.RecyclerView$LayoutManager r3 = r5.mLayout
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    tds.androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForPosition(int r6, boolean r7) {
        /*
            r5 = this;
            tds.androidx.recyclerview.widget.ChildHelper r0 = r5.mChildHelper
            int r0 = r0.getUnfilteredChildCount()
            r1 = 0
            r2 = 0
        L8:
            if (r2 >= r0) goto L3a
            tds.androidx.recyclerview.widget.ChildHelper r3 = r5.mChildHelper
            android.view.View r3 = r3.getUnfilteredChildAt(r2)
            tds.androidx.recyclerview.widget.RecyclerView$ViewHolder r3 = getChildViewHolderInt(r3)
            if (r3 == 0) goto L37
        ...
        L23:
            ...
            goto L37
        L2a:
            tds.androidx.recyclerview.widget.ChildHelper r1 = r5.mChildHelper
        ...
        L3a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.RecyclerView.findViewHolderForPosition(int, boolean):tds.androidx.recyclerview.widget.RecyclerView$ViewHolder");
    }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int i, int i2) {
            ...
            this.mOverScroller.fling(0, 0, i, i2, Integer.MIN_VALUE, IntCompanionObject.MAX_VALUE, Integer.MIN_VALUE, IntCompanionObject.MAX_VALUE);
            postOnAnimation();
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        @Override // tds.androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
  ...
  0x0183: PHI (r1v12 tds.androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
  (r1v11 tds.androidx.recyclerview.widget.RecyclerView$ViewHolder)
  (r1v31 tds.androidx.recyclerview.widget.RecyclerView$ViewHolder)
 binds: [B:28:0x005d, B:59:0x0102] A[DONT_GENERATE, DONT_INLINE]
  0x0183: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:59:0x0102] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        tds.androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            /*
                Method dump skipped, instruction units count: 619
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.RecyclerView.Recycler.tryGetViewHolderForPositionByDeadline(int, boolean, long):tds.androidx.recyclerview.widget.RecyclerView$ViewHolder");
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        boolean canRestoreState() {
            int i = AnonymousClass7.$SwitchMap$tds$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy[this.mStateRestorationPolicy.ordinal()];
            if (i != 1) {
    ...
    /* JADX INFO: renamed from: tds.androidx.recyclerview.widget.RecyclerView$7, reason: invalid class name */
    static /* synthetic */ class AnonymousClass7 {
        static final /* synthetic */ int[] $SwitchMap$tds$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy;

        static {
            int[] iArr = new int[Adapter.StateRestorationPolicy.values().length];
            $SwitchMap$tds$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy = iArr;
            try {
                iArr[Adapter.StateRestorationPolicy.PREVENT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$tds$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            ViewBoundsCheck.Callback callback = new ViewBoundsCheck.Callback() { // from class: tds.androidx.recyclerview.widget.RecyclerView.LayoutManager.1
                @Override // tds.androidx.recyclerview.widget.ViewBoundsCheck.Callback
                public View getChildAt(int i) {
            ...
            ViewBoundsCheck.Callback callback2 = new ViewBoundsCheck.Callback() { // from class: tds.androidx.recyclerview.widget.RecyclerView.LayoutManager.2
                @Override // tds.androidx.recyclerview.widget.ViewBoundsCheck.Callback
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        */
        public static int getChildMeasureSpec(int r1, int r2, int r3, boolean r4) {
            ...
            L21:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: tds.androidx.recyclerview.widget.RecyclerView.LayoutManager.getChildMeasureSpec(int, int, int, boolean):int");
        }
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        for (int size = this.mPendingAccessibilityImportanceChange.size() - 1; size >= 0; size--) {
            ...
            if (viewHolder.itemView.getParent() == this && !viewHolder.shouldIgnore() && viewHolder.mPendingAccessibilityState != -1) {
    ...
    @Override // android.view.View, tds.androidx.core.view.NestedScrollingChild
    ...
    @Override // tds.androidx.core.view.NestedScrollingChild2
    ...
    @Override // tds.androidx.core.view.NestedScrollingChild3
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimator.ItemAnimatorListener {
        ...
        @Override // tds.androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemAnimatorListener
