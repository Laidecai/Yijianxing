...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private final RecyclerView.OnScrollListener mScrollListener = new RecyclerView.OnScrollListener() { // from class: tds.androidx.recyclerview.widget.SnapHelper.1
    ...
    @Override // tds.androidx.recyclerview.widget.RecyclerView.OnFlingListener
    ...
    protected LinearSmoothScroller createSnapScroller(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) {
            return new LinearSmoothScroller(this.mRecyclerView.getContext()) { // from class: tds.androidx.recyclerview.widget.SnapHelper.2
                @Override // tds.androidx.recyclerview.widget.LinearSmoothScroller, tds.androidx.recyclerview.widget.RecyclerView.SmoothScroller
                ...
                @Override // tds.androidx.recyclerview.widget.LinearSmoothScroller
