package tds.androidx.customview.widget;
...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new Interpolator() { // from class: tds.androidx.customview.widget.ViewDragHelper.1
    ...
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: tds.androidx.customview.widget.ViewDragHelper.2
    ...
    */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.customview.widget.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
            ...
            if (this.mDragState == 1) {
                if (isValidPointerForActionMove(this.mActivePointerId)) {
                    ...
                    if (iFindPointerIndex == -1) {
                        Log.w(TAG, "Failed to find pointer index for active pointer ID " + this.mActivePointerId + ", which may indicate an inconsistent MotionEvent stream");
                        return;
                    }
