...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: tds.androidx.viewpager.ViewPager.1
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: tds.androidx.viewpager.ViewPager.4
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + g.d;
        }
    ...
    */
    protected void onPageScrolled(int r13, float r14, int r15) {
        ...
        L1b:
            ...
            tds.androidx.viewpager.ViewPager$LayoutParams r9 = (tds.androidx.viewpager.ViewPager.LayoutParams) r9
        ...
        L6b:
            ...
            tds.androidx.viewpager.ViewPager$PageTransformer r13 = r12.mPageTransformer
            if (r13 == 0) goto L9f
        ...
        L7a:
            ...
            tds.androidx.viewpager.ViewPager$LayoutParams r0 = (tds.androidx.viewpager.ViewPager.LayoutParams) r0
        ...
        L8b:
            ...
            float r3 = (float) r3
            float r0 = r0 / r3
            tds.androidx.viewpager.ViewPager$PageTransformer r3 = r12.mPageTransformer
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.viewpager.ViewPager.onTouchEvent(android.view.MotionEvent):boolean");
    }
