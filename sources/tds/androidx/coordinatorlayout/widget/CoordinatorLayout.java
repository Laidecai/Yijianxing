...
import tds.androidx.core.graphics.drawable.DrawableCompat;
import tds.androidx.core.util.ObjectsCompat;
import tds.androidx.core.util.Pools;
import tds.androidx.core.view.GravityCompat;
import tds.androidx.core.view.NestedScrollingParent2;
import tds.androidx.core.view.NestedScrollingParent3;
import tds.androidx.core.view.NestedScrollingParentHelper;
    ...
    */
    final void onChildViewsChanged(int r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: tds.androidx.coordinatorlayout.widget.CoordinatorLayout.onChildViewsChanged(int):void");
    }
    ...
    @Override // android.view.ViewGroup, android.view.ViewParent, tds.androidx.core.view.NestedScrollingParent
    public boolean onStartNestedScroll(View view, View view2, int i) {
        return onStartNestedScroll(view, view2, i, 0);
    }

    @Override // tds.androidx.core.view.NestedScrollingParent2
    ...
    @Override // tds.androidx.core.view.NestedScrollingParent3
    ...
    @Override // android.view.ViewGroup, tds.androidx.core.view.NestedScrollingParent
    ...
    private void setupForInsets() {
        ...
        if (ViewCompat.getFitsSystemWindows(this)) {
            if (this.mApplyWindowInsetsListener == null) {
                this.mApplyWindowInsetsListener = new OnApplyWindowInsetsListener() { // from class: tds.androidx.coordinatorlayout.widget.CoordinatorLayout.1
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: tds.androidx.coordinatorlayout.widget.CoordinatorLayout.SavedState.1
