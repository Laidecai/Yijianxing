    ...
    */
    ...
    public static class Factory {
        ...
        private static boolean hasConditions(Request request) {
            return (request.header("If-Modified-Since") == null && request.header(g.D) == null) ? false : true;
        }
    }
}
