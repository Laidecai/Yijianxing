...
public final class HttpHeaders {
    ...
    */
    ...
    public static boolean hasBody(Response response) {
        ...
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && contentLength(response) == -1 && !"chunked".equalsIgnoreCase(response.header(com.taptap.services.update.download.core.Util.TRANSFER_ENCODING))) ? false : true;
    }
