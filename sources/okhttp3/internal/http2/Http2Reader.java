...
final class Http2Reader implements Closeable {
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            int i = this.source.readInt() & IntCompanionObject.MAX_VALUE;
            Logger logger2 = logger;
            if (logger2.isLoggable(Level.FINE)) {
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, i2 & IntCompanionObject.MAX_VALUE, (this.source.readByte() & UByte.MAX_VALUE) + 1, (Integer.MIN_VALUE & i2) != 0);
    }
    ...
    private void readPushPromise(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        short s = (b & 8) != 0 ? (short) (this.source.readByte() & UByte.MAX_VALUE) : (short) 0;
        handler.pushPromise(i2, this.source.readInt() & IntCompanionObject.MAX_VALUE, readHeaderBlock(lengthWithoutPadding(i - 4, b, s), s, b, i2));
    }
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            int i2 = this.source.readInt() & IntCompanionObject.MAX_VALUE;
            this.streamId = i2;
            if (b != 9) {
